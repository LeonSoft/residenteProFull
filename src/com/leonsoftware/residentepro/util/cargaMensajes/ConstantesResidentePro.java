 ...
 */
public class ConstantesResidentePro {
    
    public static final String ARCHIVO_MENSAJES = "com.leonsoftware.residentepro.util.mensajes.mensajes";
    public static final String MSJ_ERROR_AUTENTICACION = "errorAutenticacion";
